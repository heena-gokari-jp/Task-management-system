...
urlpatterns = [
    ...
    ),  # List all tasks with filtering, sorting, and search
    path("create/", views.task_create, name="task_create"),  # Create a new task
    path(
        "<int:pk>/", views.task_detail, name="task_detail"
    ),  # View details of a specific task
    path(
        "<int:pk>/update/", views.task_update, name="task_update"
    ),  # Update an existing task
    path(
        "<int:pk>/delete/", views.task_delete, name="task_delete"
    ),  # Delete a specific task
    path(
        "categories/", views.category_list, name="category_list"
    ),  # List all categories
    path(
        "categories/create/", views.category_create, name="category_create"
    ),  # Create a new category
    path(
        "categories/<int:pk>/delete/", views.category_delete, name="category_delete"
